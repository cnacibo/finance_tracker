...
### Фасад (Facade) ✅
**Назначение:**
Фасад предоставляет упрощенный интерфейс для взаимодействия с группой сложных подсистем.
...
Приложение создает демонстрационные данные, выполняет анализ, экспорт и импорт данных.
